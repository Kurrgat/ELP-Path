    ...
    public void initializeAlumniRole() {
        ...
        if (alumniRole == null) {
            ...
            alumniRole.setPermissions(new HashSet<>(Arrays.asList(
                    ...
                    Permissions.ACTIVITY_CANCEL_ATTENDANCE, Permissions.ACTIVITY_ATTEND,
                    Permissions.ACTIVITY_CHAPTER_VIEW, Permissions.ACTIVITY_CHAPTER_COUNT,
                    Permissions.ACTIVITY_VIEW, Permissions.ACTIVITY_DATE_VIEW,
                    Permissions.ACTIVITY_DATE_COUNT, Permissions.ACTIVITY_ACTIVE_VIEW,
                    Permissions.ACTIVITY_ACTIVE_COUNT, Permissions.ACTIVITY_PAST_VIEW,
                    Permissions.ACTIVITY_PAST_COUNT, Permissions.ACTIVITY_SCHEDULED_VIEW,
                    Permissions.ACTIVITY_SCHEDULED_COUNT, Permissions.ACTIVITY_VIEW_ALL,
                    Permissions.ACTIVITY_COUNT_ALL,
                    Permissions.BIO_UPDATE, Permissions.BIO_ADD,
                    Permissions.BIO_VIEW, Permissions.BIO_DELETE,
                    Permissions.SKILLS_CREATE,
                    Permissions.SKILLS_DELETE_ID,
                    Permissions.SKILLS_DELETE_ALL,
                    Permissions.SKILLS_EDIT,
                    Permissions.SKILLS_GET
            )));
    ...
    public void initializeChapterLeaderRole() {
        ...
        if (chapterLeaderRole == null) {
            ...
            chapterLeaderRole.setPermissions(new HashSet<>(Arrays.asList(
                    ...
                    Permissions.ACTIVITY_TYPE_UPDATE, Permissions.ACTIVITY_TYPE_ADD,
                    Permissions.ACTIVITY_TYPE_VIEW, Permissions.ACTIVITY_TYPE_VIEW_ALL,
                    Permissions.ACTIVITY_TYPE_DELETE, Permissions.ACTIVITY_UPDATE,
                    Permissions.ACTIVITY_CANCEL_ATTENDANCE, Permissions.ACTIVITY_ATTEND,
                    Permissions.ACTIVITY_ADD, Permissions.ACTIVITY_CHAPTER_VIEW,
                    Permissions.ACTIVITY_CHAPTER_COUNT, Permissions.ACTIVITY_VIEW,
                    Permissions.ACTIVITY_DATE_VIEW, Permissions.ACTIVITY_DATE_COUNT,
                    Permissions.ACTIVITY_ACTIVE_VIEW, Permissions.ACTIVITY_ACTIVE_COUNT,
                    Permissions.ACTIVITY_PAST_VIEW, Permissions.ACTIVITY_PAST_COUNT,
                    Permissions.ACTIVITY_SCHEDULED_VIEW, Permissions.ACTIVITY_SCHEDULED_COUNT,
                    Permissions.ACTIVITY_VIEW_ALL, Permissions.ACTIVITY_COUNT_ALL,
