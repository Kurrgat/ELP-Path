...
public enum Permissions {
    ...
    SKILLS_DELETE_ID("skills:id"),
    SKILLS_DELETE_ALL("skills:all"),
    SKILLS_EDIT("skills:id"),
    ...
    ACTIVITY_TYPE_UPDATE("activityType:update"),
    ACTIVITY_TYPE_ADD("activityType:add"),
    ACTIVITY_TYPE_VIEW("activityType:view"),
    ACTIVITY_TYPE_VIEW_ALL("activityType:viewAll"),
    ACTIVITY_TYPE_DELETE("activityType:delete"),

    //activities endpoint
    ACTIVITY_UPDATE("activity:update"),
    ACTIVITY_CANCEL_ATTENDANCE("activity:cancelAttendance"),
    ACTIVITY_ATTEND("activity:attend"),
    ACTIVITY_ADD("activity:add"),
    ACTIVITY_CHAPTER_VIEW("activity:chapterView"),
    ACTIVITY_CHAPTER_COUNT("activity:chapterCount"),
    ACTIVITY_VIEW("activity:view"),
    ACTIVITY_DATE_VIEW("activity:dateView"),
    ACTIVITY_DATE_COUNT("activity:dateCount"),
    ACTIVITY_ACTIVE_VIEW("activity:activeView"),
    ACTIVITY_ACTIVE_COUNT("activity:activeCount"),
    ACTIVITY_PAST_VIEW("activity:pastView"),
    ACTIVITY_PAST_COUNT("activity:pastCount"),
    ACTIVITY_SCHEDULED_VIEW("activity:scheduledView"),
    ACTIVITY_SCHEDULED_COUNT("activity:scheduledCount"),
    ACTIVITY_VIEW_ALL("activity:allView"),
    ACTIVITY_COUNT_ALL("activity:countAll"),
