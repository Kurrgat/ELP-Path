...
//                        .requestMatchers(GET, "/schools/all").hasAuthority(SCHOOL_VIEW_ALL.name())
                ...
                //securing profile endpoint
                        ...
                        //comments endpoint
                         .requestMatchers(POST, "/add/{userId}/{feedId}").permitAll()
                        .requestMatchers(POST, "/comments/total").permitAll()
                        ...
                        //securing feeds endpoint
                        // .requestMatchers(PUT, "/feeds/{id}/edit").hasAuthority(FEEDS_UPDATE.name())
                        // .requestMatchers(POST, "/feeds/{userId}/add").hasAuthority(FEEDS_ADD.name())
                        // .requestMatchers(GET, "/feeds/{id}").hasAuthority(FEEDS_VIEW.name())
                        // .requestMatchers(GET, "/feeds/{id}/view").hasAuthority(FEEDS_USER_VIEW.name())
                        // .requestMatchers(GET, "/feeds/all").hasAuthority(FEEDS_VIEW_ALL.name())
                        // .requestMatchers(DELETE, "/feeds/{id}/delete").hasAuthority(FEEDS_DELETE.name())
                        ...
                        .requestMatchers(GET, "/branch/all").hasAuthority(BRANCH_VIEW_ALL.name())
                        ...
                        //securing activity type endpoint
                        .requestMatchers(PUT, "/activity-types/{activityTypeId}/update").hasAuthority(ACTIVITY_TYPE_UPDATE.name())
                        .requestMatchers(POST, "/activity-types/add-new-activityType").hasAuthority(ACTIVITY_TYPE_ADD.name())
                        .requestMatchers(GET, "/activity-types/{activityTypeId}/display").hasAuthority(ACTIVITY_TYPE_VIEW.name())
                        .requestMatchers(GET, "/activity-types/all").hasAuthority(ACTIVITY_TYPE_VIEW_ALL.name())
                        .requestMatchers(DELETE, "/activity-types/{activityTypeId}/delete").hasAuthority(ACTIVITY_TYPE_DELETE.name())

                        //securing activity endpoint
                        .requestMatchers(PUT, "/activities/{activityId}/update").hasAuthority(ACTIVITY_UPDATE.name())
                        .requestMatchers(POST, "/activities/{userId}/cancel-attendance/{activityId}/").hasAuthority(ACTIVITY_CANCEL_ATTENDANCE.name())
                        .requestMatchers(POST, "/activities/{userId}/attend-activity/{activityId}/").hasAuthority(ACTIVITY_ATTEND.name())
                        .requestMatchers(POST, "/activities/{chapterId}/add-new-activity").hasAuthority(ACTIVITY_ADD.name())
                        .requestMatchers(GET, "/activities/{chapterId}/display-chapter-activities").hasAuthority(ACTIVITY_CHAPTER_VIEW.name())
                        .requestMatchers(GET, "/activities/{chapterId}/count-chapter-activities").hasAuthority(ACTIVITY_CHAPTER_COUNT.name())
                        .requestMatchers(GET, "/activities/{activityId}/display").hasAuthority(ACTIVITY_VIEW.name())
                        .requestMatchers(GET, "/activities/{activityDate}/display-activities-by-date").hasAuthority(ACTIVITY_DATE_VIEW.name())
                        .requestMatchers(GET, "/activities/{activityDate}/count-activities-by-date").hasAuthority(ACTIVITY_DATE_COUNT.name())
                        .requestMatchers(GET, "/activities/display-scheduled-activities").hasAuthority(ACTIVITY_SCHEDULED_VIEW.name())
                        .requestMatchers(GET, "/activities/display-past-activities").hasAuthority(ACTIVITY_PAST_VIEW.name())
                        .requestMatchers(GET, "/activities/display-active-activities").hasAuthority(ACTIVITY_ACTIVE_VIEW.name())
                        .requestMatchers(GET, "/activities/count-scheduled-activities").hasAuthority(ACTIVITY_SCHEDULED_COUNT.name())
                        .requestMatchers(GET, "/activities/count-past-activities").hasAuthority(ACTIVITY_PAST_COUNT.name())
                        .requestMatchers(GET, "/activities/count-all-activities").hasAuthority(ACTIVITY_COUNT_ALL.name())
                        .requestMatchers(GET, "/activities/count-active-activities").hasAuthority(ACTIVITY_ACTIVE_COUNT.name())
                        .requestMatchers(GET, "/activities/all").hasAuthority(ACTIVITY_VIEW_ALL.name())
                        .requestMatchers(DELETE, "/activities/{activityId}/delete").hasAuthority(ACTIVITY_DELETE.name())
                        // securing feedback endpoint
...
//                        //skills endpoint
                        .requestMatchers(POST, "/skills/create/{userId}").permitAll()
                        .requestMatchers(DELETE, "/skills/delete/{skillId}").permitAll()
                        .requestMatchers(DELETE, "/skills/delete/all").permitAll()
                        .requestMatchers(PUT,"/skills/edit/{skillId}").permitAll()
                        .requestMatchers(GET, "/skills/get/{userId}").permitAll()
                        ...
                        //securing roles endpoint
                                .requestMatchers(GET, "/newsAndUpdates/view-all", "/NewsLetter/get-details/**", "/NewsLetter/get-pdf/**").permitAll()
                        ...
                        //sms otp endpoint
                        .requestMatchers(POST, "/sms/send-otp").hasAuthority(SMS_SEND.name())
                        .requestMatchers(POST, "/sms/verify-otp").hasAuthority(SMS_VERIFY.name())
