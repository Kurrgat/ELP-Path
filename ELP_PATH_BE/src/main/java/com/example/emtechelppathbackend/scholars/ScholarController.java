...
public class ScholarController {
    ...
    @GetMapping("/global/scholars-view")
    ResponseEntity<?> getGlobalScholars(@RequestParam(name = "year", required = false) String year,
                                        @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getGlobalScholars(year, ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    @GetMapping("/local/scholars-view")
    ResponseEntity<?> getLocalScholars(@RequestParam(name = "year", required = false) String year,
                                       @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getLocalScholars(year,ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    @GetMapping("/tvet/scholars-view")
    ResponseEntity<?> getTvetScholars(@RequestParam(name = "year", required = false) String year,
                                      @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getTvetScholars(year, ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }

    @GetMapping("/annual/scholars-view")
    ResponseEntity<?> getScholarsPerYear(@RequestParam(name = "year", required = false) String year,
                                         @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getAllScholarsPerYear(year, ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    @GetMapping("/{year}/regional/scholars-view")
    ResponseEntity<?> getRegionalScholars(@RequestParam(name = "year", required = false) String year,
                                          @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getRegionalScholars(year, ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }

    @GetMapping("/alumni/view")
    ResponseEntity<?> getAlumni(@RequestParam(name = "year", required = false) String year,
                                @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getAlumni(year,ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }

    @GetMapping("/current-scholars/view")
    ResponseEntity<?> getCurrentScholars(@RequestParam(name = "year", required = false) String year,
                                @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getCurrentScholars(year,ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    ...
    @GetMapping("/scholar-males")
    ResponseEntity<?> getMales( @RequestParam(name = "year", required = false) String year,
                                @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getMales(year, ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }

    @GetMapping("/scholar-females")
    ResponseEntity<?> getFemales( @RequestParam(name = "year", required = false) String year,
                                @RequestParam(name = "ignoreCondition", required = false, defaultValue = "false") Boolean ignoreCondition) {
        var response = scholarService.getFemales(year, ignoreCondition);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }

    @GetMapping("/registered/Unregistered/user/view")
    ResponseEntity<?> getUserStats() {
        var response = scholarService.getUserStats();
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
