...
//    List<Scholar> displayScholars() throws Exception;
    ...
    CustomResponse<?> getGlobalScholars(String year, Boolean ignoreCondition);

    CustomResponse<?> getLocalScholars(String year, Boolean ignoreCondition );
    CustomResponse<?>getTvetScholars(String year,Boolean ignoreCondition );

    Slice<Scholar> displayScholars(Pageable pageable);

    CustomResponse<?> getAllScholarsPerYear(String year,Boolean ignoreCondition);
    ...
    CustomResponse<?> getAlumni(String year, Boolean ignoreCondition);

    CustomResponse<?> getCurrentScholars(String year, Boolean ignoreCondition);

    CustomResponse<?> getRegionalScholars(String year, Boolean ignoreCondition);

    CustomResponse<?> getMales(String year, Boolean ignoreCondition);

    CustomResponse<?> getFemales(String year, Boolean ignoreCondition);

    CustomResponse<?> getUserStats();
